;; -*- lisp-version: "9.0 [64-bit Windows *SMP*] (Jun 19, 2016 16:31)"; cg: "9.0"; -*-

(in-package :cg-user)

(define-project :name :swale
  :modules (list (make-instance 'module :name "frames.lisp")
                 (make-instance 'module :name "index.lisp")
                 (make-instance 'module :name "mops.lisp")
                 (make-instance 'module :name "print-utils.lisp")
                 (make-instance 'module :name "applier.lisp")
                 (make-instance 'module :name "accepter.lisp")
                 (make-instance 'module :name "retriever.lisp")
                 (make-instance 'module :name "tweaker.lisp")
                 (make-instance 'module :name "explainer.lisp")
                 (make-instance 'module :name "swale.lisp")
                 (make-instance 'module :name "swale-mem.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
